...
public class PlayGame {
	...
	public static void TimeShift() {
		System.out.println(
				"Do you want to do Dinner before a procrastination session(1), or the procrastination session first(2)?");
